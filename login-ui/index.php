...
<head>
	...
	<link rel="stylesheet" type="text/css" href="login-ui/vendor/animsition/css/animsition.min.css">
			...
			<div class="wrap-login100">
				...
				<form method="post" id="examineeLoginFrm" class="login100-form validate-form">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<input class="input100" type="text" name="username" placeholder="firstname.surname">
