...
<html lang="en">
<head>
	<title>Student Login - BOU26</title>
	<meta charset="UTF-8">
	...
	<div class="login-container">
		...
		<div class="hero-section">
			<div class="hero-content">
				...
				<p>Your personal student portal for examination and learning management. Empowering your academic journey.</p>
			</div>
				...
				<form method="post" id="examineeLoginFrm">
					<div class="form-group">
						...
						<div class="input-wrapper">
							...
							<input class="input-field" type="text" name="username" placeholder="e.g. BOU26/JSS3/001" required>
						</div>
					</div>
