                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn" style="font-weight:600;color:var(--text-dark);">
                                            <span class="d-none d-sm-inline"><?php echo strtoupper($selExmneeData['exmne_fullname']); ?></span>
                                            <i class="fa fa-user-circle ml-2 opacity-8 d-inline d-sm-none" style="font-size:20px;"></i>
                                            <i class="fa fa-angle-down ml-2 opacity-8"></i>
                                        </a>
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                            <button type="button" tabindex="0" class="dropdown-item">My Account</button>
                                            <div tabindex="-1" class="dropdown-divider"></div>
                                            <a href="query/logoutExe.php" class="dropdown-item" style="color:#ef4444;">LOG OUT</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
